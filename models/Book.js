...
const bookPlatformSchema = new Schema({
...
const bookSchema = new mongoose.Schema({
  ...
  genre: {
    ...
    validate: {
      ...
      message: 'Please add one or more Genres'
    }
  },
  targetAudience: {
    type: [String],
  ...
  recommendedBook: { type: bookPlatformSchema},
  bookOfTheWeek: { type: bookPlatformSchema},
  bookTop10: { type: bookPlatformSchema},
  bookPopular: { type: bookPlatformSchema},
  inEdition: {
    type: Boolean,
    default: true,
  },

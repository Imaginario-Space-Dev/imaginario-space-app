...
const CoursesHomeCategory = ({list}) => {
  ...
  return (
    <Wrapper>
    <div className='home-films-content mt-3'>
    <div className='home-films-categ d-flex justify-content-start align-items-center mb-2'>
    <h3 className='category-1-title my-0 p-0 '>Courses</h3>
...
export default CoursesHomeCategory

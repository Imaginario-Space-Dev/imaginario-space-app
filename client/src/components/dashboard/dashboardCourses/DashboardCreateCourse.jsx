...
const DashboardCreateCourse = ({currentUser}) => {
...
const handleSaveCourse = async () => {
  ...
  try {
    const res = await axiosInstance.post('/courses', newPost);
    setLoadingSave(false);
    navigate(`/imaginario-spaces/${res?.data?.data?.createdBy}/course/${res?.data?.data?._id}`)

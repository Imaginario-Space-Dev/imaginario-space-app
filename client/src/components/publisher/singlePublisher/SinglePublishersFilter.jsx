...
import { SinglePublisherCategory} from '../../index'
import {FaFilter, FaWindowClose } from 'react-icons/fa'

const SinglePublishersFilter = ({list, action, trackProfile}) => {
  ...
  return (
    ...
    <SinglePublisherCategory list={list} action={action} trackProfile={trackProfile}/>
...
export default SinglePublishersFilter

...
const CategoryContainerSlider = ({films}) => {
  ...
  return (
    <Wrapper>
        ...
        <Slider {...settings}>
          ...
          const { id, url } = item;
          return (
            <Link to={url + id}  key={id} className='home-film'>
              
                {/* <Film film={{...item}} screenWidth={width}/> */}
                <FilmsTest film={{...item}} screenWidth={width} book= {book}/>
             </Link>
          );
        })}
        </Slider>
...
export default CategoryContainerSlider
